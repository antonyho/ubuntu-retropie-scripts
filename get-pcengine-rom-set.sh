#!/bin/bash
# Get no-intro PC Engine ROM set
...
if [ $# -lt 2 ]; then
	...
	echo "Usage:"
	echo "./get-pcengine-rom-set.sh <username> <password>"
else
	...
	unzip $HOME/RetroPieInstallation/no-intro-pcengine-rom-set.zip -d $HOME/RetroPie/roms/pcengine/
fi
